...
def main():
    ...
    while running:
        ...
        # Print current game state and Q-values for debugging
        print(f"Current Game State: Paddle One Y: {paddle_one_y_position}, Paddle Two Y: {paddle_two_y_position}, Ball XY: {ball_x_and_y_position}")
        print("Q-Values Paddle One:")
        print(q_learning.q_table_paddle_one)
